...
# @router.post("/login")
# async def login(credentials: UserResponse):
#     print("Received login attempt")
#     user = db.find_user({"email": credentials.username})  # Change to credentials.email if needed
...
# Add this Pydantic model at the top of server.py
...
async def login(credentials: LoginRequest):
    try:
        ...
        user = db.find_user({"username": credentials.username})
